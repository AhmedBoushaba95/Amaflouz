    ...
    <div class="bloc">
            ...
            <ul>
                ...
                <li><a>CATÃ‰GORIES</a>
                    <ul>
                        ...
                        <li><a href="Tel.php">TÃ©lÃ©phonie</a></li>
                        <li><a href="Info.php">Informatique</a></li>
                        <li><a href="Elec.php">Ã‰lectromÃ©nager</a></li>
                        <li><a href="Jeux.php">Jeux vidÃ©o</a></li>
                    </ul>
                </li>
                <li><a>CONTACT</a></li>
                <li><a>MON COMPTE</a>
        ...
        <div class="log">
            ...
            if (isset($_SESSION['connect'])) {
                ?>
                <ul class="ul">
                    <li class="li"><a class="co" href="deconnexion.php">DÃ©connexion</a></li>
                </ul>
                <?php
            } else {
                ?>
...
$req = $database->prepare("SELECT * FROM Produits WHERE Cat = 1");
$req->execute();
?>
...
while($tab = $req->fetch())
{
    ...
    <div class = "produit">
       ...
       <a href="produit.php?id=<?php print $tab['ID'] ?>"> <img src="<?php echo nl2br($tab['Img']) ?>">
        <p><?php echo nl2br(utf8_encode($tab['Description'])) ?></p>
        <p><?php echo nl2br($tab['Prix']) ?> Euros</p></a>
        </div>
